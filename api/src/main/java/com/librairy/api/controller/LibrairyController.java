...
public class LibrairyController {
    ...
    public Optional<Librairy> getLibrairy(@PathVariable("id") final Long id){
    ...
    public Librairy updateLibrairy(@PathVariable("id") final Long id, @RequestBody Librairy librairy){
    ...
    public void deleteLibrairy (@PathVariable("id") final Long id){
